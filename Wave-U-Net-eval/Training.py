...
def cfg():
    ...
    model_config = {"musdb_path" : "/mnt/disks/datasets/musdb18", # SET MUSDB PATH HERE, AND SET CCMIXTER PATH IN CCMixter.xml
                    ...
                    "epoch_it" : 200, # Number of supervised separator steps per epoch
...
def train(model_config, experiment_id, sup_dataset, unsup_dataset=None, load_model=None):
    ...
    #global_step = estimator._load_global_step_from_checkpoint_dir(model_config['model_base_dir'])
    ...
    if load_model != None:
        ...
        #restorer = tf.train.import_meta_graph('/mnt/disks/musdb-gpu-checkpoints/605012/605012-20502.meta')
        ...
        # print('==================================START')
        # # print(load_model)
        # restorer = tf.train.import_meta_graph(load_model)
        # checkpoint_file='/mnt/disks/musdb-gpu-checkpoints/625589'
        # restorer.restore(sess, tf.train.latest_checkpoint(checkpoint_file))
        # chkp.print_tensors_in_checkpoint_file(checkpoint_file, tensor_name='', all_tensors=True)
        # # sess.run(tf.initialize_all_variables())
        # print('==================================END')
        # print('restored pretrained model from file' + load_model)
...
def optimise(model_config, experiment_id, dataset):
    epoch = 0
    best_loss = 10000
    model_path = '/mnt/disks/musdb-gpu-checkpoints/605012/605012-20502'
    ...
    test_loss = 0.0016087406977480306
